...
class AccountHoldersActiveTest {
  ...
  @Test
  void shouldReturnPrimaryHolder_whenNoJointActiveHoldersExist() {
    ...
    assertThat(accountHolders.active())
      .containsExactly(primaryHolder);
  }

  @Test
  void shouldSortPrimaryBeforeJoint_whenInputOrderIsDifferent() {
    var primaryHolder = BankAccountTestFixture.createPrimaryHolder(PRIMARY_ACCOUNT_HOLDER);
    var jointHolder = BankAccountTestFixture.createJointHolder(JOINT_ACCOUNT_HOLDER);

    var accountHolders = AccountHolders.of(jointHolder, primaryHolder);
  ...
  @Test
  void shouldReturnOnlyPrimaryHolder_whenJointHolderIsInactive() {
    var primaryHolder = BankAccountTestFixture.createPrimaryHolder(PRIMARY_ACCOUNT_HOLDER);
    var jointHolder = BankAccountTestFixture.createJointHolder(JOINT_ACCOUNT_HOLDER);
