...
class PersonalInfoDetailsMapperTest {
  ...
  private final IdentityDocumentDetailsMapper identityMapper =
    new IdentityDocumentDetailsMapper() {};

  private final PersonalInfoDetailsMapper mapper = new PersonalInfoDetailsMapperImpl(identityMapper);
