...
class ActivateBankAccountUseCaseImplTest {
  ...
  @BeforeEach
  void setUp() {
    useCase = new ActivateBankAccountUseCaseImpl(bankAccountLookupRepository, bankAccountUpdateRepository);
  }
  ...
  void shouldActivateBankAccount_whenCommandIsValid() {
    ...
    var command = ActivateBankAccountCommand.of(BANK_ACCOUNT_ID);
